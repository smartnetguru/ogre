...
The takeaway:
* It should be easy to make changes to multiple resumes
* It should be easy to get help with these resumes
* It should be easy to present these resumes to employers
